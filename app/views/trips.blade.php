        ...
        <div class="row cells4">
            ...
            <div class="cell colspan3">
                <div class="row cells6">
                    <div class="cell">
                        <div class="image-container rounded"><img style="height: 121px;" src="./images/computing.jpg"></div>

                    </div>

                    <div class="cell colspan5">
                        <div class="row">
                            <div class="cell" style="margin-left: 15;"><h4><a class="fg-cyan fg-hover-darkCyan" href="http://www.tnmoc.org/">National Museum of Computing</a></h4></div>
